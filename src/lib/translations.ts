...
export const translations = {
  en: {
    ...
    successMessage: 'Message shared! Your message remains saved for future use.',
    autosaveNote: 'Your message is automatically saved as you type',
  ...
  fr: {
    ...
    successMessage: 'Message partagé! Votre message reste sauvegardé pour une utilisation future.',
    autosaveNote: 'Votre message est automatiquement sauvegardé pendant que vous tapez',
